					...
					var n,
						...
						r = u("paint", function (t) {
							"first-contentful-paint" === t.name &&
								(r && r.disconnect(),
								t.startTime < i.timeStamp && ((a.value = t.startTime), a.entries.push(t), p.add(a), n()));
						});
					r &&
						((n = d(t, a, e)),
						f(function (i) {
					...
					var n,
						...
						v = function (t) {
							t.startTime < r.timeStamp &&
								((m.value = t.processingStart - t.startTime), m.entries.push(t), p.add(m), n());
						},
						l = u("first-input", v);
					(n = d(t, m, e)),
						l &&
...
//# sourceMappingURL=3.48289b6b.chunk.js.map
